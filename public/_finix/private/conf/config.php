...
const _CONFIG_ = [
    ...
    */
    ...
    "_finix/public/ext/" (no check for existence).
    ...
    */
    ...
    - sizes: array of numbers
        ...
        so that it will be persistent.
    - theme: string, name of one of the folders in "_finix/images/themes", defaults to "default"
    ...
    */
    ...
    First checks for files "_finix.header.html" and "_finix.footer.html" in the current directory.
    If not successful it checks all parent directories (starting in the current directory) for
    files "_finix.headers.html" and "_finix.footers.html".
    ...
    */
    ...
    /*
    Localization, for example "en", "de" etc. - see "_finix/conf/l10n" folder for
    ...
    */
    ...
    /*
    Show thumbnails for image files. Needs the "/_finix/cache" folder to be
